        ...
        <div className="chat__chats">
            ...
            <div className="chat__userInfoCol">
              ...
              <div className="chat__statusRow">
                <span className="chat__status">
                  ...
                  application, 20 applications over a 30 min period (total exposure time 10 min).
                </span>
          ...
          <div className="chat__userRow">
            ...
            <div className="chat__userInfoCol">
              ...
              <div className="chat__statusRow">
                <span className="chat__status">
                  Ask CDCR San Quintin State Prison 2008. We installed Purex dispensers throughout
                  the prison to combat diseases…and it was a Roaring Success (as in Roaring Drunk) I
                  mean we had Long lines of prisoners fist fighting to use them.
                </span>
              </div>
            </div>
          </div>
            ...
            <div className="chat__userInfoCol">
              ...
              <div className="chat__statusRow">
                <span className="chat__status">
                  ...
                  same amount of alcohol as in a 150 lb adult, that might amount to 3.1 to 6.0 mg/L
                  in the child’s body—still far below an intoxicating effect.{' '}
                </span>
              </div>
            </div>
          </div>
          <div className="chat__userRow">
            ...
            <div className="chat__userInfoCol">
              ...
              <div className="chat__statusRow">
                <span className="chat__status">
                  In most states, the legal limit in blood alcohol to not be considered DUI is 500
                  to 1,000 mg/L. Therefore, this is way below a level considered to be intoxication.
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="chat__userRow">
            ...
            <div className="chat__userInfoCol">
              ...
              <div className="chat__statusRow">
                <span className="chat__status">
                  Simultaneously we had a problem with prisoner drunkenness that we couldn’t figure
                  out. I mean , the guards searched cells multiple times to no avail.{' '}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="chat__messageWrapper">
            ...
            <div className="chat__messageContainer chat__messageContainer_sent">
              <div className="chat__messageInner chat__messageInner_sent">
                <p className="chat__messageText">I confirm. When should I expect the payment?</p>
            ...
            <div className="chat__messageContainer">
              ...
              <div className="chat__messageInner">
                <p className="chat__messageText">
                  You will receive your payment within 48 hours from the moment of confirmation
                </p>
